    ...
    break;
     ...
     case 3:
         ...
         case 0:
    	    ...
    	    tx_thread_sleep(300);//tx_thread_sleep(100);//HAL_Delay(20); //WT.EDIT .2024.08.10//HAL_Delay(20);
    	    beijing_step =1;
         ...
         case 1:
        	    ...
        	    tx_thread_sleep(300);//tx_thread_sleep(100);//HAL_Delay(20); //WT.EDIT .2024.08.10
